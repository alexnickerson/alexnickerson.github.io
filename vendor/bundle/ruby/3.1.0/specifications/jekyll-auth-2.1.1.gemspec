# -*- encoding: utf-8 -*-
# stub: jekyll-auth 2.1.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<rack-protection>.freeze, ["~> 1.5", ">= 1.5.5"])
    ...
    s.add_development_dependency(%q<rubocop>.freeze, ["~> 0.49", ">= 0.49.0"])
    ...
    s.add_dependency(%q<rack-protection>.freeze, ["~> 1.5", ">= 1.5.5"])
    ...
    s.add_dependency(%q<rubocop>.freeze, ["~> 0.49", ">= 0.49.0"])
